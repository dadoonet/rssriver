package org.elasticsearch.river.rss.support;
 ...
 * RSS Feed Parser
 * 
 * @author http://www.vogella.de/articles/RSSFeed/article.html
 */
public class RssFeedParser {
	...
	private String getEventData(XMLEvent event) {
		if (event != null && event instanceof Characters) {
