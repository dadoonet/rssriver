...
<pre>
$ bin/plugin -install rssriver -url http://cloud.github.com/downloads/dadoonet/rssriver/rssriver-0.0.6.zip
</pre>
...
In a next version, RSS River will be sync'ed to Maven central so you will be able to do:
